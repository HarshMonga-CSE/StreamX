  ...
  return (
    <div className='h-screen flex items-center justify-center p-4 sm:p-6 md:p-8' data-theme="dark">
      ...
      <div className='mb-4 flex items-center justify-start gap-2'>
        ...
        <span className='text-3xl font-bold font-mono bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary tracking-wider'>StreamX</span>
      </div>
      ...
      <div className='w-full'>
        <form onSubmit={handleSignup}>
          ...
          <div>
            ...
            <p className='text-sm opacity-70'>Join StreamX and start your language learning adventure!</p>
          </div>
